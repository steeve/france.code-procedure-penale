...
III.-Pour les prestations ne figurant pas dans les tableaux annexés, le montant
du remboursement prévu aux I et II est déterminé sur devis.

I. - Tarifs hors taxe applicables aux prestations requises aux opérateurs de
téléphonie mobile
...
numéro d'appel avec un minimum de perception de 20 numéros.
...
forme électronique non copiable.
...
II. - Tarifs hors taxe applicables aux prestations requises aux opérateurs de
téléphonie fixe
...
Identification en nombre d'abonnés, à partir de leur numéro d'appel (avec ou
...
reçue sous forme papier, par fax ou sous forme électronique non copiable.
...
Recherche et identification d'un abonné appelant derrière une tête de ligne ou
un serveur.
...
Identification d'un abonné à partir du nom ou de la raison sociale et filtre sur
d'autres critères.
...
Identification d'un abonné à partir de l'adresse de son installation
téléphonique.
...
comprend la localisation des bornes, la mise en service et l'historique.
